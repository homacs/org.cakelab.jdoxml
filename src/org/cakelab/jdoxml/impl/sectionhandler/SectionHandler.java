...
public class SectionHandler extends BaseHandler<SectionHandler> implements IUserDefined
{
	...
	private List<MemberHandler> m_members = new ArrayList<MemberHandler>();            // memberdef
...
{
  for (MemberHandler mh : m_members)
  {
...
public IMemberIterator members() 
{ 
  return new MemberIterator(m_members); 
    ...
    public boolean isProtected()
    {
      return m_kind==SectionKind.ProTypes || m_kind==SectionKind.ProFuncs || m_kind==SectionKind.ProAttribs ||
             m_kind==SectionKind.ProSlots || m_kind==SectionKind.ProStatFuncs || m_kind==SectionKind.ProStatAttribs;
    }
    public boolean isPrivate()
    {
      return m_kind==SectionKind.PriTypes || m_kind==SectionKind.PriFuncs || m_kind==SectionKind.PriAttribs ||
             m_kind==SectionKind.PriSlots || m_kind==SectionKind.PriStatFuncs || m_kind==SectionKind.PriStatAttribs;
    }
